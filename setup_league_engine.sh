#!/bin/bash
set -e
# 1) Agrega NAMES al module.exports de gameEngine.js
sed -i 's/module.exports = { generateSquad, generatePlayer, buildClub, rngFactory, overallFor, marketValue, classOf };/module.exports = { generateSquad, generatePlayer, buildClub, rngFactory, overallFor, marketValue, classOf, NAMES };/' firebase/cloud-functions/gameEngine.js

# 2) Crea leagueEngine.js
cat > firebase/cloud-functions/leagueEngine.js << 'LEAGUEENGINE_EOF'
/**
...
echo "Listo. Verificando que carga sin errores..."
node -e "const le = require('./firebase/cloud-functions/leagueEngine.js'); console.log(Object.keys(le));"
