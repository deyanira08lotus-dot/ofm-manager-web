#!/bin/bash
set -e
cat > firebase/cloud-functions/matchEngine.js << 'MATCHENGINE_EOF'
/**
...
node -e "const me = require('./firebase/cloud-functions/matchEngine.js'); console.log(Object.keys(me));"

echo "Ahora verificando leagueEngine.js (necesita matchEngine.js)..."
